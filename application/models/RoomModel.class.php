...
class RoomModel {
  ...
  {
    $database = new Database();
    $sql = "SELECT RoomName, LowSeasonPriceDay, NumberOfPersonn, Description, PlusBed, PlusPersonn, Bed, SeperateWC, RelaxSpace, WithBabyBed, WithCouch, Office, Photo1, Photo2, Photo3, Photo4, Photo5, Photo6, Photo7, Photo8, Photo9, Photo10 FROM rooms WHERE RoomId = :room_id";
